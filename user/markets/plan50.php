...
<div class="container">
    <div class="row">
        <div class="col-xl-4 bg-secondary p-4">
            ...
            <div>
                <hr>
                <p class="text-center bg-dark p-2">Amount to pay: <br> <?= '$' . number_format(50, 2) ?> + 5 = <?= '$' . number_format(55, 2) ?><br>Processing fee inclusive.</p>
                <hr>
                ...
                <form id="pl_50_rrusdt_02">
                    <label for="">Enter amount paid</label>
                    <input type="hidden" name="return" value="0.05" id="">
                    <input type="hidden" id="package" name="package" value="<?= $plan ?>">
                    <input type="hidden" name="email" value="<?= $email ?>" id="">
                    <input type="number" id="amount" name="amount" class="form-control form-control-sm bg-dark border-0 mt-2 text-light" placeholder="E.g. $55.00">
