...
<div class="container">
    <div class="row">
        <div class="col-xl-4 bg-secondary p-4">
            ...
            <div>
                <p class="text-center bg-dark p-2">Amount to pay: <br> <?= '$' . number_format(5000, 2) ?> + 50 = <?= '$' . number_format(5050, 2) ?><br>Processing fee inclusive.</p>
                ...
                <form id="pl_5000_rrusdt_08">
                    <label for="">Enter amount paid</label>
                    <input type="hidden" name="return" value="0.11" id="">
                    <input type="hidden" id="package" name="package" value="<?= $plan ?>">
                    <input type="hidden" name="email" value="<?= $email ?>" id="">
                    <input type="number" id="amount" name="amount" class="form-control form-control-sm bg-dark border-0 mt-2 text-light" placeholder="E.g. $5050.00">
