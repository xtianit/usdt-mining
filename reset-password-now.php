...
<head>
    <meta charset="UTF-8" />
    <title>T-Cloud - Reset Password</title>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-xl-4 p-5 m-5 mx-auto shadow-lg">
                    ...
                    <form id="complete-password-reset">
                        <input type="hidden" id="email" name="email" value="<?= $email ?>">
                        <input name="password" type="password" id="password" placeholder="Enter a new password" class="px-0 mb-3 form-control form-control-sm border-0 bg-transparent border-bottom" style="border-radius:0; outline: none;">
                        <input name="confirmPassword" type="password" placeholder="Confirm new password" class="px-0 mb-3 form-control form-control-sm border-0 bg-transparent border-bottom" style="border-radius:0; outline: none;">
                        <div class="d-flex align-items-center justify-content-center"">
							<button class=" btn btn-sm btn-info w-100">Reset now</button>
                        </div>

                        <p class="text-center mt-3">Don't have an account? <a href="./signup.php">Sign up here</a></p>
                        <p class="text-center mt-3"><a href="./signin.php">Sign in here</a></p>
                    </form>
