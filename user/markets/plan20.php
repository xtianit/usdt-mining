...
<div class="container mx-auto">
    <div class="row">
        <div class="col-xl-4 bg-secondary p-4">
            ...
            <div>
                <hr>
                <p class="text-center bg-dark p-2">Amount to pay: <br> <?= '$' . number_format(20, 2) ?> + 2 = <?= '$' . number_format(22, 2) ?><br>Processing fee inclusive.</p>
                ...
                <form id="pl_20_rrusdt_01">
                    <label for="">Enter amount paid</label>
                    <input type="hidden" name="return" value="0.04" id="">
                    <input type="hidden" id="package" name="package" value="<?= $plan ?>">
                    <input type="hidden" name="email" value="<?= $email ?>" id="">
                    <input type="number" id="amount" name="amount" class="form-control form-control-sm bg-dark border-0 mt-2 text-light" placeholder="E.g. $22.00">
