...
// Populate the name select dropdown
data.forEach((name) => {
...
// Bind the change event of the name select
nameSelect.addEventListener("change", function () {
    var selectedname = this.value;
    stateSelect.innerHTML = '<option value="">Select State</option>';

    if (selectedname !== "") {
        var selectednameData = data.find((name) => name.name === selectedname);
        if (selectednameData && selectednameData.states) {
            selectednameData.states.forEach((state) => {
                var option = document.createElement("option");
                option.value = state;
                option.text = state;
