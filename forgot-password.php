...
<head>
    <meta charset="UTF-8" />
    <title>T-Cloud - Forgot Password</title>
        ...
        <div class="container mt-5">
            <div class="row">
                <div class="col-xl-4 p-5 m-5 mx-auto shadow-lg">
                    ...
                    <h5 class="text-center">Password Verification</h5>
                    <p class="text-center alert alert-info">Let's send you a verification code.</p>
                    <form id="password-reset">
                        ...
                        <div class="d-flex align-items-center justify-content-center"">
							<button class=" btn btn-sm btn-info w-100">Email me a code</button>
                        </div>
                        <p class="text-center mt-3">Already a trader? <a href="./signin.php">Sign In</a></p>
